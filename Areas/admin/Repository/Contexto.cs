...
namespace casamento.Areas.admin.Repository
{
    public class Contexto : IDisposable
    {
        ...
        public Contexto()
        {
             var conexaoString = ConfigurationManager.ConnectionStrings["CasamentoBD"].ConnectionString;
             //var conexaoString = ConfigurationManager.ConnectionStrings["CasamentoBDLocal"].ConnectionString;
